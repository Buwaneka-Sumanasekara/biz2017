...
-- Dumping data for table bizdb.m_group1: ~1 rows (approximately)
/*!40000 ALTER TABLE `m_group1` DISABLE KEYS */;
INSERT IGNORE INTO `m_group1` (`ID`, `NAME`, `ACTIVE`, `ISHIDDEN`) VALUES
	('G1000', '', 1, 1);
...
-- Dumping data for table bizdb.m_group2: ~1 rows (approximately)
/*!40000 ALTER TABLE `m_group2` DISABLE KEYS */;
INSERT IGNORE INTO `m_group2` (`ID`, `NAME`, `ACTIVE`, `ISHIDDEN`) VALUES
	('G2000', '', 1, 1);
...
-- Dumping data for table bizdb.m_group3: ~1 rows (approximately)
/*!40000 ALTER TABLE `m_group3` DISABLE KEYS */;
INSERT IGNORE INTO `m_group3` (`ID`, `NAME`, `ACTIVE`, `ISHIDDEN`) VALUES
	('G3000', '', 1, 1);
...
-- Dumping data for table bizdb.m_group4: ~1 rows (approximately)
/*!40000 ALTER TABLE `m_group4` DISABLE KEYS */;
INSERT IGNORE INTO `m_group4` (`ID`, `NAME`, `ACTIVE`, `ISHIDDEN`) VALUES
	('G4000', '', 1, 1);
...
-- Dumping data for table bizdb.m_group5: ~1 rows (approximately)
/*!40000 ALTER TABLE `m_group5` DISABLE KEYS */;
INSERT IGNORE INTO `m_group5` (`ID`, `NAME`, `ACTIVE`, `ISHIDDEN`) VALUES
	('G5000', '', 1, 1);
...
INSERT IGNORE INTO `m_permissions` (`ID`, `PARENTID`, `NAME`, `DESCRIPTION`, `TYPE`, `HASSUB`, `ISUIMENU`, `ORD`, `TREE_ICON`) VALUES
	...
	('R00103', 'R00101', 'R_STOCK_2', 'Stock Balance Summary -Mult Units', 'RPT', 0, 1, 303, 'Report_sub.png'),
...
-- Dumping data for table bizdb.user_permitions: ~147 rows (approximately)
...
INSERT IGNORE INTO `user_permitions` (`M_USERGROUP_ID`, `M_PERMISSIONS_ID`, `M_PERMISSIONS_PARENTID`, `ACCESSTYPE`) VALUES
	...
	(0, 'M00008', 'M00000', 'null'),
	(0, 'M00009', 'M00000', 'null'),
	(0, 'M00010', 'M00000', 'null'),
